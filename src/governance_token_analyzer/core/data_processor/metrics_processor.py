...
class MetricsProcessor:
    ...
    def calculate_distribution_metrics(self, token_holders: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        median_balance = sorted_balances[holder_count // 2] if holder_count % 2 == 1 else (
            sorted_balances[holder_count // 2 - 1] + sorted_balances[holder_count // 2]
        ) / 2
