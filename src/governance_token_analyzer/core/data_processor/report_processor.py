...
"""
    ...
    def _generate_comparison_summary(self, protocols: List[str], metrics: Dict[str, Any]) -> str:
        ...
        metrics_table = "| Protocol | Gini Coefficient | Top 10 Concentration | Participation Rate | Decentralization Score |\n"
        metrics_table += "|----------|-----------------|----------------------|-------------------|------------------------|\n"
        ...
        for protocol in protocols:
            ...
            metrics_table += f"| {protocol_name} | {gini:.4f} | {top10:.2f}% | {participation:.2f}% | {decentralization:.2f} |\n"
