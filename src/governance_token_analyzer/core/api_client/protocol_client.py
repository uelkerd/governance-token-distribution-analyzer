    ...
    def _generate_sample_proposal_data(self, protocol: str, count: int) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            if "{reason}" in description:
                reasons = ["community development", "grants program", "protocol improvements", "security audits", "bug bounties"]
            ...
            if "{feature}" in description:
                features = ["improved liquidation mechanism", "better interest rate model", "new risk management features", "enhanced governance"]
