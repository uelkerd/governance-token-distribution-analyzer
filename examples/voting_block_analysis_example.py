...
def main():
    ...
    print(f"  Generated {len(proposals)} proposals with {len(token_holders)} token holders")
    ...
    for block_id, data in block_power.items():
        print(f"  {block_id}: {data['address_count']} addresses, "
