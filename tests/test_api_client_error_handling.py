...
from governance_token_analyzer.core.api_client import APIClient, TOKEN_ADDRESSES, GRAPHQL_ENDPOINTS, ETHPLORER_API_URL
...
def test_multiple_protocol_errors():
    ...
    with patch('governance_token_analyzer.core.api_client.APIClient._fetch_compound_token_holders', 
               side_effect=Exception("API Error")), \
         patch('governance_token_analyzer.core.api_client.APIClient._fetch_uniswap_token_holders', 
               side_effect=Exception("API Error")), \
         patch('governance_token_analyzer.core.api_client.APIClient._fetch_aave_token_holders', 
               side_effect=Exception("API Error")), \
         patch('governance_token_analyzer.core.api_client.APIClient._fetch_compound_proposals', 
               side_effect=Exception("API Error")), \
         patch('governance_token_analyzer.core.api_client.APIClient._fetch_uniswap_proposals', 
               side_effect=Exception("API Error")), \
         patch('governance_token_analyzer.core.api_client.APIClient._fetch_aave_proposals', 
               side_effect=Exception("API Error")):
